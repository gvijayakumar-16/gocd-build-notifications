...
public class GoNotificationMessage {
     ...
     */
    public History fetchRecentPipelineHistory()
    ...
    public Pipeline fetchDetailsForBuild(int counter)
        throws URISyntaxException, IOException, BuildDetailsNotFoundException
    {
        History history = fetchRecentPipelineHistory();
        if (history != null) {
    ...
    public void tryToFixStageResult()
    {
        ...
        try {
            history = fetchRecentPipelineHistory();
        } catch(Exception e) {
    ...
    public Pipeline fetchDetails()
        throws URISyntaxException, IOException, BuildDetailsNotFoundException
    {
        return fetchDetailsForBuild(Integer.parseInt(getPipelineCounter()));
    }

    public List<MaterialRevision> fetchChanges()
        throws URISyntaxException, IOException
    {
        Server server = serverFactory.getServer();
